...
- `delegate_task` の結果はユーザーに見えないため、自分の言葉で整理して ask_selection の description に含める
...
### Step 4: レポートの提示
調査結果を以下の構造でレポートにまとめ、テキスト出力で提示する:
...
- 「特定の点を深掘りする」→ `ask_user` で深掘りポイントを聞き、追加調査
